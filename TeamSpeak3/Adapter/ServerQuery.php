...
class ServerQuery extends AbstractAdapter
{
    ...
    {
        $query = HelperString::factory($cmd)->section(TeamSpeak3::SEPARATOR_CELL);
        ...
        do {
            ...
            $rpl[] = $str;
        } while ($str instanceof HelperString && $str->section(
    ...
    public function wait()
    {
        ...
        } while ($evt instanceof HelperString && !$evt->section(TeamSpeak3::SEPARATOR_CELL)->startsWith(
                TeamSpeak3::EVENT
            ));
        ...
        foreach ($params as $ident => $value) {
            ...
            if (is_array($value)) {
                ...
                for ($i = 0; $i < count($value); $i++) {
                    ...
                    $cells[$i][] = $ident . HelperString::factory($value[$i])->escape()->toUtf8();
                }
            } else {
                if ($value === null) {
                    continue;
                ...
                $args[] = $ident . HelperString::factory($value)->escape()->toUtf8();
            }
        }
